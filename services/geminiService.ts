    ...
    deviceCategories: [
      {
        ...
        devices: [
            { name: "Defibrillator", imageQuery: "defibrillator" },
            { name: "Ventilator", imageQuery: "hospital ventilator" },
            { name: "Infusion Pump", imageQuery: "infusion pump" },
            { name: "Dialysis Machine", imageQuery: "dialysis machine" },
            { name: "Electrosurgical Unit", imageQuery: "electrosurgical unit" },
            { name: "External Pacemaker", imageQuery: "external pacemaker" },
            { name: "Insulin Pump", imageQuery: "insulin pump" },
            { name: "Nebulizer", imageQuery: "nebulizer" },
            { name: "Surgical Laser", imageQuery: "surgical laser" },
            { name: "Lithotripter", imageQuery: "lithotripter" },
            { name: "CPAP Machine", imageQuery: "cpap machine" },
            { name: "Heart-Lung Machine", imageQuery: "heart lung machine" },
            { name: "Anesthesia Machine", imageQuery: "anesthesia machine" },
            { name: "Gamma Knife", imageQuery: "gamma knife" },
            { name: "Linear Accelerator", imageQuery: "linear accelerator" },
            { name: "Hyperbaric Oxygen Chamber", imageQuery: "hyperbaric chamber" },
            { name: "Enteral Feeding Pump", imageQuery: "feeding pump" },
            { name: "PCA Pump", imageQuery: "pca pump" },
            { name: "Medical Suction Machine", imageQuery: "medical suction" },
            { name: "Cryotherapy Unit", imageQuery: "cryotherapy" },
            { name: "Laser Therapy Unit", imageQuery: "laser therapy" }
        ],
      },
      {
        ...
        devices: [
            { name: "ECG Machine", imageQuery: "ecg machine" },
            { name: "Ultrasound Machine", imageQuery: "ultrasound machine" },
            { name: "MRI Machine", imageQuery: "mri machine" },
            { name: "CT Scanner", imageQuery: "ct scanner" },
            { name: "Patient Monitor", imageQuery: "patient monitor" },
            { name: "X-ray Machine", imageQuery: "x-ray machine" },
            { name: "Endoscope", imageQuery: "endoscope" },
            { name: "Ophthalmoscope", imageQuery: "ophthalmoscope" },
            { name: "Otoscope", imageQuery: "otoscope" },
            { name: "Sphygmomanometer", imageQuery: "blood pressure monitor" },
            { name: "Pulse Oximeter", imageQuery: "pulse oximeter" },
            { name: "Glucometer", imageQuery: "glucometer" },
            { name: "PET Scanner", imageQuery: "pet scanner" },
            { name: "EEG Machine", imageQuery: "eeg machine" },
            { name: "EMG Machine", imageQuery: "emg machine" },
            { name: "Spirometer", imageQuery: "spirometer" },
            { name: "Bone Densitometer", imageQuery: "bone densitometer" },
            { name: "Fetal Doppler", imageQuery: "fetal doppler" },
            { name: "Bronchoscope", imageQuery: "bronchoscope" },
            { name: "Colonoscope", imageQuery: "colonoscope" }
        ],
      },
      {
          ...
          devices: [
              { name: "TENS Unit", imageQuery: "TENS unit" },
              { name: "Gait Trainer", imageQuery: "gait trainer" },
              { name: "Traction Bed", imageQuery: "traction bed" },
              { name: "Hydrotherapy Pool", imageQuery: "hydrotherapy" },
              { name: "CPM Machine", imageQuery: "cpm machine" },
              { name: "Parallel Bars", imageQuery: "rehabilitation parallel bars" },
              { name: "Therapeutic Ultrasound", imageQuery: "therapeutic ultrasound" },
              { name: "Electrical Stimulation Machine", imageQuery: "electrical stimulation therapy" },
              { name: "Shoulder Wheel", imageQuery: "shoulder wheel physical therapy" },
              { name: "Prosthetic Limb", imageQuery: "prosthetic limb" },
              { name: "Orthotic Brace", imageQuery: "orthotic brace" }
          ]
      }
    ],
    deviceDetails: {
    ...
    deviceCategories: [
      {
        ...
        devices: [
            { name: "جهاز الصدمات الكهربائية", imageQuery: "defibrillator" },
            { name: "جهاز التنفس الصناعي", imageQuery: "hospital ventilator" },
            { name: "مضخة التسريب", imageQuery: "infusion pump" },
            { name: "جهاز غسيل الكلى", imageQuery: "dialysis machine" },
            { name: "وحدة الجراحة الكهربائية", imageQuery: "electrosurgical unit" },
            { name: "منظم ضربات القلب الخارجي", imageQuery: "external pacemaker" },
            { name: "مضخة الأنسولين", imageQuery: "insulin pump" },
            { name: "جهاز البخاخات", imageQuery: "nebulizer" },
            { name: "ليزر جراحي", imageQuery: "surgical laser" },
            { name: "جهاز تفتيت الحصى", imageQuery: "lithotripter" },
            { name: "جهاز ضغط الهواء الإيجابي المستمر", imageQuery: "cpap machine" },
            { name: "جهاز القلب والرئة الاصطناعي", imageQuery: "heart lung machine" },
            { name: "جهاز التخدير", imageQuery: "anesthesia machine" },
            { name: "سكين جاما", imageQuery: "gamma knife" },
            { name: "المسرع الخطي", imageQuery: "linear accelerator" },
            { name: "غرفة الأكسجين عالي الضغط", imageQuery: "hyperbaric chamber" },
            { name: "مضخة التغذية المعوية", imageQuery: "feeding pump" },
            { name: "مضخة تسكين الألم الذاتية", imageQuery: "pca pump" },
            { name: "جهاز الشفط الطبي", imageQuery: "medical suction" },
            { name: "وحدة العلاج بالتبريد", imageQuery: "cryotherapy" },
            { name: "وحدة العلاج بالليزر", imageQuery: "laser therapy" }
        ],
      },
      {
        name: "أجهزة تشخيصية",
        ...
        devices: [
            { name: "جهاز تخطيط القلب", imageQuery: "ecg machine" },
            { name: "جهاز الموجات فوق الصوتية", imageQuery: "ultrasound machine" },
            { name: "جهاز الرنين المغناطيسي", imageQuery: "mri machine" },
            { name: "جهاز التصوير المقطعي", imageQuery: "ct scanner" },
            { name: "جهاز مراقبة المريض", imageQuery: "patient monitor" },
            { name: "جهاز الأشعة السينية", imageQuery: "x-ray machine" },
            { name: "منظار داخلي", imageQuery: "endoscope" },
            { name: "منظار العين", imageQuery: "ophthalmoscope" },
            { name: "منظار الأذن", imageQuery: "otoscope" },
            { name: "مقياس ضغط الدم", imageQuery: "blood pressure monitor" },
            { name: "مقياس تأكسج النبض", imageQuery: "pulse oximeter" },
            { name: "جهاز قياس السكر", imageQuery: "glucometer" },
            { name: "ماسح التصوير المقطعي بالإصدار البوزيتروني", imageQuery: "pet scanner" },
            { name: "جهاز تخطيط كهربائية الدماغ", imageQuery: "eeg machine" },
            { name: "جهاز تخطيط العضلات الكهربائي", imageQuery: "emg machine" },
            { name: "مقياس التنفس", imageQuery: "spirometer" },
            { name: "مقياس كثافة العظام", imageQuery: "bone densitometer" },
            { name: "جهاز دوبلر لمراقبة الجنين", imageQuery: "fetal doppler" },
            { name: "منظار القصبات", imageQuery: "bronchoscope" },
            { name: "منظار القولون", imageQuery: "colonoscope" }
        ],
      },
      {
          ...
          devices: [
              { name: "جهاز TENS", imageQuery: "TENS unit" },
              { name: "جهاز تدريب المشي", imageQuery: "gait trainer" },
              { name: "سرير الشد", imageQuery: "traction bed" },
              { name: "حوض العلاج المائي", imageQuery: "hydrotherapy" },
              { name: "جهاز الحركة السلبية المستمرة", imageQuery: "cpm machine" },
              { name: "قضبان متوازية", imageQuery: "rehabilitation parallel bars" },
              { name: "جهاز الموجات فوق الصوتية العلاجي", imageQuery: "therapeutic ultrasound" },
              { name: "جهاز التحفيز الكهربائي", imageQuery: "electrical stimulation therapy" },
              { name: "عجلة الكتف", imageQuery: "shoulder wheel physical therapy" },
              { name: "طرف صناعي", imageQuery: "prosthetic limb" },
              { name: "دعامة تقويمية", imageQuery: "orthotic brace" }
          ]
      }
    ],
    deviceDetails: {
